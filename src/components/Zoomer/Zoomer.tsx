...
import genPhyllotaxis, { GenPhyllotaxis, GenPhyllotaxisFunction, PhyllotaxisPoint } from '@visx/mock-data/lib/generators/genPhyllotaxis'
        ...
        {(zoom) => (
          <div className={`relative`}>
            ...
            <div className={`mini-map`}>
              <button type={`button`} className={`btn btn-lg`} onClick={() => setShowMiniMap(!showMiniMap)}>
